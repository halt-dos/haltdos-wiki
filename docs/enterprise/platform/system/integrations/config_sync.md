...
![config sync](/img/platform/v7/docs/newsnaps/v8config_sync.png)
...
| Accept Remote Connections | Enable lo/accept sync with peer management | ENABLED / DISABLED | DISABLED |
