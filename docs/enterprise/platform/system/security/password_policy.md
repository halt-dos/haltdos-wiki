...
![password_policy](/img/platform/v7/docs/newsnaps/v8pswd.png)
...
|----------------------       |---------------------------------------------------------                                         |-----------------|---------|
| Enable                      | Enable organization specific password policy                                                     | Boolean         | False   |
| Default Password            | Specify the default password for system login mode for new user                                  | String          |
...
| Contain Numbers Name        | Specify if the password must compulsory contain numbers                                          | Boolean         |True   |
